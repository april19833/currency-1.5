...
/**
 * @title Proposal
 * @dev Interface specification for proposals. Any proposal submitted in the
...
interface Proposal {
    ...
    /**
     * @dev A longer description of what this proposal achieves.
     */
    function description() external view returns (string memory);

    /**
     * @dev A URL where voters can go to see the case in favour of this proposal,
     * and learn more about it.
     */
    function url() external view returns (string memory);

    /**
     * @dev Called to enact the proposal.
     *

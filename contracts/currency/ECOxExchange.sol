...
contract ECOxExchange is Policed {
    ...
    /**
     * @dev Calculates the value of ECOx by multiplying value by supply
     * @param _ecoXValue the value of ECOx
     * @return the value of ECOx multiplied by total supply
     */
    ...
    /**
     * @dev Calculates the value of ECOx at the total supply snapshot
     * @param _ecoXValue the value of ECOx
     * @return the value of ECOx multiplied by the total supply at the time of snapshot
     */
    ...
    /**
     * @dev Exchange ECOx for ECO by burning ECOx and minting ECO
    ...
    /**
     * @dev Computes the value of ECO from the ECOx value and the ECO supply
     * @param _ecoXValue the value of ECOx
     ...
     * @return `e ^ (x / 2 ^ precision) * 2 ^ precision`, that is, the result is upshifted for accuracy.
     */
    function generalExp(
        uint256 _x,
        uint8 _precision

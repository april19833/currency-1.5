...
for when a cycle is attempted to be finalized before it finishes
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    uint256
    |
    the cycle submitted by the end user to access
    |
    |
    currentCycle
    |
    uint256
    |
    the current cycle as calculated by the contract
    |
...
for when a proposal is submitted with too long of a description
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    uint256
    |
    the length of the submitted description, to be compared against MAX_DESCRIPTION_DATA
    |
...
for when a proposal is submitted with too many actions or zero actions
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    uint256
    |
    the length of the submitted targets array, to be compared against MAX_TARGETS and 0
    |
...
error for when a proposalId in a trustee's vote is not one from the current cycle or is completely invalid
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    vote
    |
    struct CurrencyGovernance.Vote
    |
    the vote containing the invalid proposalId
    |
...
error for when the proposalIds in a trustee's vote are not strictly increasing
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    struct CurrencyGovernance.Vote
    |
    the vote before the invalid vote
    |
    |
    vote
    |
    struct CurrencyGovernance.Vote
    |
    the vote with the non-increasing proposalId
    |
...
error for when a score in a trustee's vote is either duplicate or doesn't respect support weightings
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    struct CurrencyGovernance.Vote
    |
    the vote containing the invalid score
    |
...
emits when the trustedNodes contract is changed
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    |
    denotes the new trustedNodes contract address
    |
    |
    oldTrustedNodes
    |
    contract TrustedNodes
    |
    denotes the old trustedNodes contract address
    |
...
emits when the enacter contract is changed
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    newEnacter
    |
    contract MonetaryPolicyAdapter
    |
    denotes the new enacter contract address
    |
    |
    oldEnacter
    |
    contract MonetaryPolicyAdapter
    |
    denotes the old enacter contract address
    |
...
emitted when a proposal is submitted to track the values
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    address
    |
    the address of the trustee that submitted the proposal
    |
    |
    _cycle
    |
    uint256
    |
    the cycle during which the proposal was submitted
    |
    |
    id
    |
    bytes32
    |
    the lookup id for the proposal in the proposals mapping is created via a hash of _cycle, _targets, _signatures, and _calldatas; see getProposalHash for more details
    |
    |
    _description
    |
    string
    |
    a string allowing the trustee to describe the proposal or link to discussions on the proposal
    |
...
emitted when a trustee adds their support for a proposal
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    address
    |
    the address of the trustee supporting
    |
    |
    proposalId
    |
    bytes32
    |
    the lookup for the proposal being supported
    |
    |
    cycle
    |
    uint256
    |
    the cycle during which the support action happened
    |
...
emitted when a trustee retracts their support for a proposal
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    address
    |
    the address of the trustee unsupporting
    |
    |
    proposalId
    |
    bytes32
    |
    the lookup for the proposal being unsupported
    |
    |
    cycle
    |
...
emitted when the last trustee retracts their support for a proposal
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    bytes32
    |
    the lookup for the proposal being deleted
    |
    |
    cycle
    |
    uint256
    |
    the cycle during which the unsupport deletion action happened
    |
...
Fired when a trustee commits their vote.
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    address
    |
    the trustee that committed the vote
    |
    |
    cycle
    |
...
Records the voter, as well as all of the parameters of the vote cast.
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    address
    |
    the trustee who revealed their vote
    |
    |
    cycle
    |
    uint256
    |
    the cycle when the vote was cast and counted
    |
    |
    votes
    |
    struct CurrencyGovernance.Vote[]
    |
    the array of Vote structs that composed the trustee's ballot
    |
...
Fired when vote results are computed, creating a permanent record of vote outcomes.
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    uint256
    |
    the cycle for which this is the vote result
    |
    |
    winner
    |
    bytes32
    |
    the proposalId for the proposal that won
    |
...
only available to the owning policy contract
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    contract TrustedNodes
    |
    the value to set the new trustedNodes address to, cannot be zero
    |
...
only available to the owning policy contract
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    contract MonetaryPolicyAdapter
    |
    the value to set the new enacter address to, cannot be zero
    |
...
calculates and returns the current cycle and the current stage
  ...
  Return Values | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    [0]
    |
    struct CurrencyGovernance.TimingData
    |
    TimingData type of { uint256 cycle, Stage stage }
    |
...
calculates and returns, used internally
  ...
  Return Values | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    uint256
    |
    cycle the index for the currently used governance recording mappings
    |
...
doesn't check to see if the address is a trustee
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    address
    |
    the address to check. not msg.sender for dapp related purposes
    |
...
need to link to borda count analysis by christian here
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    bytes32
    |
    the lookup ID for the proposal that's being supported
    |
...
the last person who unsupports the proposal deletes the proposal
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    bytes32
    |
    the lookup ID for the proposal that's being unsupported
    |
...
calling additional times overwrites previous commitments
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    bytes32
    |
    the hash commit to check against when revealing the structure of the commit is keccak256(abi.encode(salt, cycleIndex, msg.sender, votes)) where votes is an array of Vote structs
    |
...
in revealing the vote, votes are tallied, a running tally of each proposal's votes is kept in storage during this phase
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    address
    |
    the trustee's commit to try and reveal trustees can obviously reveal their own commits, but this allows for a delegated reveal the commit structure means that only the correct committed vote can ever be revealed, no matter who reveals it reveals are attributed to this trustee
    |
    |
    _salt
    |
    bytes32
    |
    the salt for the commit hash to make the vote secret
    |
    |
    _votes
    |
    struct CurrencyGovernance.Vote[]
    |
    the array of Vote objects { bytes32 proposal, uint256 ranking } that follows our modified Borda scheme. The votes need to be arranged in ascending order of address and ranked via the integers 1 to the number of proposals ranked.
    |
...
send the results to the adapter for enaction
  ...
  Parameters | Name | Type | Description | | ---- | ---- | ----------- |
    ...
    uint256
    |
    cycle index must match the cycle just completed as denoted on the proposal marked by the leader variable
    |

...
```solidity
function rebase(uint256 _inflationMultiplier) external nonpayable
```
...
| Name | Type | Description |
|---|---|---|
| _inflationMultiplier | uint256 | undefined |

### rebasers

```solidity
function rebasers(address) external view returns (bool)
```
...
```solidity
function snapshotters(address) external view returns (bool)
```
...
```solidity
function updateRebasers(address _key, bool _value) external nonpayable
```



*change the rebasing permissions for an address only callable by tokenRoleAdmin*
...
```solidity
function updateSnapshotters(address _key, bool _value) external nonpayable
```
...
| Name | Type | Description |
|---|---|---|
| adjustinginflationMultiplier  | uint256 | undefined |
| cumulativeInflationMultiplier  | uint256 | undefined |

...
const CurrencyTimerProxy = '0x953d8bC7410D189C83713151bA506D33ea5Bf995' // used to check lockups
...
export async function getExistingEco(defaultSigner: SignerWithAddress): Promise<OldEcoProxies> {
    ...
    const ecoXStaking = new ECOxStaking__factory(defaultSigner).attach(ECOxStakingProxy)
